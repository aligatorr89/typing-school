...
/*!*******************************************!*\
  !*** ./src/app/shared/AnalyticsResult.ts ***!
  \*******************************************/
/*! exports provided: analyticsResultsKeys, AnalyticsResult */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!********************************************************!*\
  !*** ./src/app/shared/TypingSchoolIndexedDbQueries.ts ***!
  \********************************************************/
/*! exports provided: getLast100Results, getAllData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!************************************!*\
  !*** ./src/app/shared/ViewHelp.ts ***!
  \************************************/
/*! exports provided: appMarkBinded, findSelectElement, setSelectElementOptions, getAnalyticsResultsTable, resultsTableRow, getAnalyticsResultsTableRowNode, getTextChunk */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"appMarkBinded\", function() { return appMarkBinded; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"findSelectElement\", function() { return findSelectElement; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setSelectElementOptions\", function() { return setSelectElementOptions; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getAnalyticsResultsTable\", function() { return getAnalyticsResultsTable; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"resultsTableRow\", function() { return resultsTableRow; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getAnalyticsResultsTableRowNode\", function() { return getAnalyticsResultsTableRowNode; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getTextChunk\", function() { return getTextChunk; });\n/* harmony import */ var _AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AnalyticsResult */ \"./src/app/shared/AnalyticsResult.ts\");\n\r\nconst appMarkBinded = ' ra-b';\r\nfunction findSelectElement(elementName) {\r\n    const elements = document.getElementsByTagName('select');\r\n    for (let i = 0; i < elements.length; i++) {\r\n        if (elements[i].name === elementName) {\r\n            elements[i].name += appMarkBinded;\r\n            return elements[i];\r\n        }\r\n    }\r\n}\r\nfunction setSelectElementOptions(node, array) {\r\n    for (let i = 0; i < array.length; i++) {\r\n        const option = document.createElement('option');\r\n        option.value = array[i];\r\n        option.textContent = array[i];\r\n        node.appendChild(option);\r\n    }\r\n}\r\nfunction getAnalyticsResultsTable(data) {\r\n    const node = document.createElement('table');\r\n    node.setAttribute('class', 'results-table');\r\n    let table = '<thead><tr>';\r\n    for (let i = 0; i < _AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__[\"analyticsResultsKeys\"].length; i++) {\r\n        table += '<th class=\"text-center border\">' + _AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__[\"analyticsResultsKeys\"][i] + '</th>';\r\n    }\r\n    table += '</thead></tr><tbody>';\r\n    if (!Array.isArray(data)) {\r\n        return '';\r\n    }\r\n    for (let i = 0; i < data.length; i++) {\r\n        table += resultsTableRow(data[i]);\r\n    }\r\n    table += '</tbody>';\r\n    node.innerHTML = table;\r\n    return node;\r\n}\r\nfunction resultsTableRow(row) {\r\n    let tr = '<tr class=\"text-center\">';\r\n    for (let j = 0; j < _AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__[\"analyticsResultsKeys\"].length; j++) {\r\n        tr += '<td class=\"border\">' + JSON.stringify(row[_AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__[\"analyticsResultsKeys\"][j]]) + '</td>';\r\n    }\r\n    tr += '</tr>';\r\n    return tr;\r\n}\r\nfunction getAnalyticsResultsTableRowNode(row) {\r\n    const tr = document.createElement('tr');\r\n    tr.className = 'text-center';\r\n    let str = '';\r\n    for (let j = 0; j < _AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__[\"analyticsResultsKeys\"].length; j++) {\r\n        str += '<td class=\"border\">' + JSON.stringify(row[_AnalyticsResult__WEBPACK_IMPORTED_MODULE_0__[\"analyticsResultsKeys\"][j]]) + '</td>';\r\n    }\r\n    tr.innerHTML = str;\r\n    return tr;\r\n}\r\nfunction getTextChunk(textChunk) {\r\n    let html = '';\r\n    for (let i = 0; i < textChunk.length; i++) {\r\n        html += '<span class=\"word\">' + textChunk[i] + '&nbsp;</span> ';\r\n    }\r\n    return html;\r\n}\r\n\n\n//# sourceURL=webpack:///./src/app/shared/ViewHelp.ts?");
